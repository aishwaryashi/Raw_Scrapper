...
## Corpus Check
- 13 files · ~65,629 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1146 nodes · 1345 edges · 61 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d6421085`
...
- `handleListing()` --calls--> `extractListingPage()`  [EXTRACTED]
  src/routes.js → src/extract.js
- `handleDetail()` --calls--> `extractScrapedAdDetails()`  [EXTRACTED]
  src/routes.js → src/extract.js
- `handleListing()` --calls--> `extractAdIdFromUrl()`  [EXTRACTED]
  src/routes.js → src/helpers.js
...
Cohesion: 0.10
Nodes (47): buildAdRecord(), coalesce(), COUNTRY_MAP, deepGet(), __dirname, enrichLocationGeo(), extractAdId(), extractAllEmbeddedJson() (+39 more)
...
Cohesion: 0.13
Nodes (15): type, type, type, type, properties, type, hideAddressOnAd, hideEmailOnAd (+7 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (18): format, type, $ref, description, type, example, type, $ref (+10 more)

### Community 8 - "Community 8"
Cohesion: 0.10
Nodes (21): type, type, type, type, type, properties, type, display (+13 more)
...
Cohesion: 0.06
Nodes (33): type, type, type, type, type, type, type, propertyType (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (17): type, type, type, type, city, country, countryCode, district (+9 more)
...
Cohesion: 0.29
Nodes (7): enum, type, enums, adexpirystatus, yesNo, enum, type
...
Cohesion: 0.09
Nodes (36): isFirestoreReady(), backoffDelay(), buildHeaders(), buildPaginationUrl(), getSeenAdIds(), isDetailUrl(), isDuplicate(), isListingUrl() (+28 more)
...
Cohesion: 0.67
Nodes (3): format, type, adexpirydate

## Knowledge Gaps
- **841 isolated node(s):** `title`, `type`, `schemaVersion`, `title`, `type` (+836 more)
...
- **Why does `enums` connect `Community 31` to `Community 9`, `Community 42`, `Community 11`, `Community 44`, `Community 45`, `Community 46`, `Community 47`, `Community 48`, `Community 49`, `Community 50`, `Community 43`, `Community 52`, `Community 53`, `Community 51`, `Community 55`, `Community 56`, `Community 57`, `Community 58`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `properties` connect `Community 12` to `Community 7`, `Community 8`, `Community 11`, `Community 13`, `Community 14`, `Community 19`, `Community 60`?**
